...
<body>
	<div align="center">
		登录用户：[${sessionScope.USER_IN_SESSION.username}] <a href="/login">注销登录</a>
	</div>
	<hr/>
	<form action="/product?cmd=save" method="POST">
		...
		<table border="1" cellpadding="10" cellspacing="0">
			...
			<tr>
				<td>商品简介</td>
				<td><textarea name="note" cols="50" rows="6"
						required="required" draggable="false">${p.note}</textarea></td>
			</tr>
			<tr>
				<td>商品价格</td>
			...
			<tr>
				<td>商品数量</td>
				<td><input type="number" name="count" value="${p.count}"
					required /></td>
			</tr>
			<tr>
				<td>所属目录</td>
				<td><select name="dir" required>
			...
			<tr>
				<td>所属子目录</td>
				<td><select name="subDir" required>
			...
			<tr>
				<td colspan="2"><input type="submit"
					value="${p.id==null?'保存商品信息':'修改商品信息'}" /></td>
			</tr>
		</table>
	</form>
</body>
